    ...
    <div className={`about-us ${sidebar ? "open" : ""}`}>
      ...
      <main className="container">
        ...
        <p>
          ...
          energy. TR undertake to maximise the Local Content of any project it
          executes, while maintaining the local and international quality and
          safety standards..
        </p>
        ...
        <section className="who-we-are-wrapper mt-5">
          ...
          <div className="wrapper row mb-5">
            <div className="first col-sm-6">
              ...
              <h5>Our Purpose</h5>
              <p>
                Our purpose is to produce and deliver energy, water and food to
                the world in a sustainable matter
              </p>
            </div>
            <div className="first col-sm-6">
